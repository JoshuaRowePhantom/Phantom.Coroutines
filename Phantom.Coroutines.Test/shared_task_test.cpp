...
static_assert(std::same_as<shared_task_traits<void>, shared_task_traits<void>>);
static_assert(std::same_as<shared_task<>, shared_task<>>);
static_assert(has_void_await_suspend<shared_task_awaiter<shared_task<>>>);
//static_assert(has_co_await<shared_task<>>);

//static_assert(is_awaiter<shared_task_awaiter<shared_task<>>>);
//static_assert(is_awaiter<shared_task_awaiter<shared_task<int>>>);
//static_assert(is_awaiter<shared_task_awaiter<shared_task<int&>>>);
//
//static_assert(is_awaiter<shared_task_awaiter<shared_task<>&>>);
//static_assert(is_awaiter<shared_task_awaiter<shared_task<int>&>>);
//static_assert(is_awaiter<shared_task_awaiter<shared_task<int&>&>>);
//
//static_assert(is_awaitable<shared_task<>>);
//static_assert(is_awaitable<shared_task<int>>);
//static_assert(is_awaitable<shared_task<int&>>);
//
//static_assert(has_co_await<shared_task<>&>);
//static_assert(has_co_await<shared_task<>&&>);
...
//static_assert(std::same_as<shared_task_awaiter<shared_task<void>>, decltype(std::declval<shared_task<void>>().operator co_await())>);
//static_assert(std::same_as<shared_task_awaiter<shared_task<void>&>, decltype(std::declval<shared_task<void>&>().operator co_await())>);
//static_assert(std::same_as<shared_task_awaiter<shared_task<void>>, decltype(std::declval<shared_task<void>&&>().operator co_await())>);
//
//static_assert(std::same_as<awaitable_result_type_t<shared_task<>&>, void>);
//static_assert(std::same_as<awaitable_result_type_t<shared_task<int>&>, int&>);
//static_assert(std::same_as<awaitable_result_type_t<shared_task<int&>&>, int&>);
//
...
//static_assert(std::same_as<awaitable_result_type_t<shared_task<int>>, int>);
//static_assert(std::same_as<awaitable_result_type_t<shared_task<int&>>, int&>);
//static_assert(std::same_as<awaitable_result_type_t<shared_task<std::string>>, std::string>);
//static_assert(std::same_as<awaitable_result_type_t<shared_task<std::string&>>, std::string&>);
//
