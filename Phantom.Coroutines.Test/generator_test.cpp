...
{
static_assert(GeneratorTraits<generator_traits<int>>);
...
static_assert(std::same_as<generator_iterator<int>, generator<int>::iterator_type>);
...
TEST(generator_test, Can_enumerate_empty_generator)
{
	...
	generator_iterator<int> i;
	//auto i = generator.begin();
