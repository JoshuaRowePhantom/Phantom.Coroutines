...
#define PHANTOM_COROUTINES_CLANG_PUSH_DISABLE_WARNING(warnings)
#define PHANTOM_COROUTINES_CLANG_POP_WARNINGS()

#define PHANTOM_COROUTINES_PUSH_DISABLE_INTERNAL_LINKAGE_WARNING() PHANTOM_COROUTINES_MSVC_PUSH_DISABLE_WARNING(5046)
#define PHANTOM_COROUTINES_POP_WARNINGS() PHANTOM_COROUTINES_MSVC_POP_WARNINGS()
