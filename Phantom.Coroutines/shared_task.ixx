...
private:
    ...
    )
    {
            ...
            [&](state_type previousState) -> std::optional<state_type>
        {
            ...
            awaiter->m_nextAwaiter = previousState.template as<WaitingCoroutineState>();
...
public:
    ...
    {
        state_type state = m_atomicState.exchange(
            CompletedState{},
        ...
        auto awaiter = state.template as<WaitingCoroutineState>();
