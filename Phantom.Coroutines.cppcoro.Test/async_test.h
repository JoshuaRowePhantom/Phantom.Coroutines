#ifndef PHANTOM_COROUTINES_INCLUDE_ASYNC_TEST_H
#define PHANTOM_COROUTINES_INCLUDE_ASYNC_TEST_H

#include <gtest/gtest.h>
#include "Phantom.Coroutines/reusable_task.h"


namespace Phantom::Coroutines::cppcoro::Test
{
void ExecuteTest(
...
{ \
    ::Phantom::Coroutines::cppcoro::Test::ExecuteTest(AsyncTestBody()); \
} \
\
